...
class ThreadPoolServer extends Thread {
    ...
    public ThreadPoolServer(Socket socket, int idNum) {
        this.sock = socket;
        this.id = idNum;
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        /*try {
            ...
            System.out.println("[NumThreads] must be an integer");
            System.exit(2);
        }*/
        try{
            ...
            while (true) {
                ...
                //Performer performer = new Performer(sock, strings);// These two lines
                //performer.doPerform();                             // belong in run.
                ThreadPoolServer newServerThread = new ThreadPoolServer(sockT, idNum++);
